...
def model_wrapper(
    ...
    def get_model_input_time(t_continuous):
        ...
        if noise_schedule.schedule == 'discrete':
            return (t_continuous - 1. / noise_schedule.total_N) * float(diff_steps[0])
        else:
            return t_continuous

    def noise_pred_fn(x, t_continuous, cond=None,x_mark_enc=None):
        ...
        if model_type == "noise":
            ...
            dims = x.dim()
            #print(x.shape,dims,alpha_t.shape,output.shape,sigma_t.shape)
    ...
    def cond_grad_fn(x, t_input):
        ...
        with torch.enable_grad():
            ...
            log_prob = classifier_fn(x_in, t_input, condition, x_mark_enc,**classifier_kwargs)
