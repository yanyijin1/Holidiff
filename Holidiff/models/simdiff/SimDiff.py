...
import numpy as np
from Holidiff.models.simdiff.rotaryembedding import RotaryEmbedding
...
import math
from Holidiff.models.simdiff.dpm_sampler import DPMSolverSampler
from Holidiff.models.simdiff.diffusion_utils import *
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.device = str(getattr(configs, 'torch_device', 'cuda' if torch.cuda.is_available() else 'cpu'))
