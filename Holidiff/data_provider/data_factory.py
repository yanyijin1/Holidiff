from Holidiff.data_provider.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_M4, PSMSegLoader, \
...
from Holidiff.data_provider.fujian30_loader import Fujian30CsvDataset, Fujian30NpyDataset
from Holidiff.data_provider.uea import collate_fn
...
def data_provider(args, flag):
    ...
    if args.task_name == 'anomaly_detection':
        ...
        if args.data == 'm4':
            drop_last = False
        if args.data == 'fujian30':
            data_set = Data(
                csv_path=args.root_path + '/' + args.data_path,
                adj_path=args.root_path + '/adjacent_gantry.csv',
                split=flag,
