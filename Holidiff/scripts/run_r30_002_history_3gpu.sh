...
RUN_ROOT="/root/autodl-tmp/STdiff_runs/history_boundary_r30_002"
LAUNCH_LOG_ROOT="/root/autodl-tmp/STdiff_runs/launch_logs/r30_002_3gpu"
...
DATASETS=("PEMS03-R30-002" "PEMS04-R30-002" "PEMS08-R30-002")
GPUS=("0" "1" "2")
...
PID_FILE="${LAUNCH_LOG_ROOT}/r30_002_3gpu_ep${TRAIN_EPOCHS}_seed${SEED}.pids"
printf '%s\n' "${PIDS[@]}" > "${PID_FILE}"
